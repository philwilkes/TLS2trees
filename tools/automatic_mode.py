...
from post_segmentation_script_simplified_with_cleaned_pc import PostProcessing
import glob
import numpy as np
from measure_cleaned2 import MeasureTree
...
if __name__ == '__main__':
    ...
    for point_cloud in point_clouds_to_process:
        ...
        parameters = {'directory':'../',
                      ...
                      'batch_size':20, #could be interesting to see if batchsize of 1 is better
